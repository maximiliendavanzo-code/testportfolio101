...
def render_finance_home():
    ...
    render_how_it_works(t("howitworks_title"), [
        (t("howitworks_1_title"), t("howitworks_1_desc")),
        (t("howitworks_2_title"), t("howitworks_2_desc")),
        (t("howitworks_3_title"), t("howitworks_3_desc")),
    ])
...
def render_ma_page():
    ...
    if dcf_result is None:
        ...
        syn_mode_label = t("ma_syn_mode_cost") if syn_mode in (None, t("ma_syn_mode_cost")) else t("ma_syn_mode_revenue")
        ff_png = None
        if valuation_ranges:
            try:
