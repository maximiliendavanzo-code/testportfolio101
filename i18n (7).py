...
TRANSLATIONS = {
    ...
    "tool_cib_desc": {
        "fr": "Explorez le financement et la structuration des opérations bancaires : valorisation, "
              "dette, financement, avec des données réelles.",
        "en": "Explore the financing and structuring of banking operations: valuation, "
              "debt, financing, with real data.",
    },
    "tool_ma_desc": {
        "fr": "Valorisez et structurez vos opérations de fusions-acquisitions : DCF, comparables, "
              "transactions, synergies, avec des données réelles.",
        "en": "Value and structure your mergers & acquisitions deals: DCF, comparables, "
              "transactions, synergies, with real data.",
    },
    ...
    "howitworks_1_desc": {
        "fr": "Sélectionnez l'outil adapté à votre analyse : Portfolio101 pour un portefeuille d'actions, M&A101 pour une acquisition.",
        "en": "Select the tool suited to your analysis: Portfolio101 for a stock portfolio, M&A101 for an acquisition.",
    },
    "howitworks_2_title": {"fr": "Entrez vos données", "en": "Enter your data"},
    "howitworks_2_desc": {
        "fr": "Renseignez les tickers, montants ou hypothèses nécessaires : un ticker comme \"AAPL\", ou une croissance de 8% par an.",
        "en": "Enter the tickers, amounts, or assumptions needed: a ticker like \"AAPL\", or an 8% annual growth rate.",
    },
    "howitworks_3_title": {"fr": "Analysez les résultats", "en": "Analyze the results"},
    "howitworks_3_desc": {
        "fr": "Consultez les indicateurs calculés automatiquement : rendement, volatilité, ou valeur par action.",
        "en": "Review the automatically computed indicators: return, volatility, or value per share.",
    },
    "footer_text": {
