...
st.set_page_config(page_title="Portfolio101", page_icon="assets/favicon.png", layout="wide")
st.logo("assets/logo_wordmark.png", icon_image="assets/favicon.png", size="large")
...
st.image("assets/logo_wordmark.png", width=320)
