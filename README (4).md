...
- **M&A101** : valorisation d'une société cible par DCF, comparables boursiers
  (données réelles), transactions précédentes (saisie manuelle), synergies,
  et graphique football field récapitulatif.
