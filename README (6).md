...
- **Direction artistique "verre optique"** : cartes translucides avec effet de flou
  (glassmorphism), dégradés de fond tintés par la couleur de l'outil actif, typographie
  Source Serif 4 (titres) + Manrope (contenu), jauges en anneau pour les indicateurs clés
  de Portfolio101 (`theme.py`).
