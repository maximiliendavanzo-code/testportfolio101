...
def render_hero_illustration(title: str, label_return: str, value_return: str,
    ...
    """Illustration façon aperçu produit : ordinateur portable stylisé + 2 cartes flottantes (verre)."""
    ...
    _html(f"""
    <div style="position:relative; height:380px; margin-top:16px;">
      <div style="position:absolute; top:6px; left:0; width:140px; z-index:2; background:rgba(255,255,255,0.6);
                  backdrop-filter:blur(14px); border:1px solid rgba(255,255,255,0.75); border-radius:16px;
                  padding:14px; box-shadow:0 10px 30px rgba({accent_rgb},0.14);">
      ...
      <div style="position:absolute; top:70px; right:0; width:126px; z-index:2; background:rgba(255,255,255,0.6);
                  backdrop-filter:blur(14px); border:1px solid rgba(255,255,255,0.75); border-radius:16px;
                  padding:14px; box-shadow:0 10px 30px rgba({accent_rgb},0.14);">
      ...
      <div style="position:absolute; top:36px; left:96px; right:56px; z-index:1;">
        <div style="background:#1c1e2b; border-radius:16px 16px 6px 6px; padding:10px 10px 14px;
                    box-shadow:0 24px 50px rgba({accent_rgb},0.28);">
          <div style="background:#fbfaff; border-radius:10px; padding:16px;">
        ...
        <div style="height:16px; margin:0 -14px; background:linear-gradient(#3a3d52,#1c1e2b);
                    clip-path:polygon(-8% 0%, 108% 0%, 100% 100%, 0% 100%); border-radius:0 0 8px 8px;"></div>
      </div>
    </div>
    """)
