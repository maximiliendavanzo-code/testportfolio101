...
TRANSLATIONS = {
    ...
    "howitworks_1_desc": {"fr": "Sélectionnez l'outil adapté à votre analyse.", "en": "Select the tool suited to your analysis."},
    "howitworks_2_title": {"fr": "Entrez vos données", "en": "Enter your data"},
    "howitworks_2_desc": {"fr": "Importez vos actifs ou renseignez vos hypothèses.", "en": "Import your assets or fill in your assumptions."},
    "howitworks_3_title": {"fr": "Analysez les résultats", "en": "Analyze the results"},
    "howitworks_3_desc": {"fr": "Obtenez des insights clairs pour prendre les meilleures décisions.", "en": "Get clear insights to make the best decisions."},
    "footer_text": {
